...
import { countries, genders, ages, devices, imageSizes, days, HourSchedule, bids, adYoutube, youtubeChannels } from "../../shared-modules/data";
...
let CreateYoutubeCampaignComponent = class CreateYoutubeCampaignComponent {
    constructor(_formBuilder, afs, youtubeService, auth) {
        ...
        this.placeholderYoutubeChannels = 'Sélectionnez vos chaines youtubes';
    ...
    ngOnInit() {
        this.firstFormGroup = this._formBuilder.group({
            name: ['', [Validators.required], [FormValidators.youtubeCampaignNameValidator(this.afs)]],
    ...
    getFirstForm() {
        ...
        //console.log(this.firstFormGroup.value['youtubeChannels'])
    ...
    onSelectAllYoutubeChannels() {
        const selected = this.youtubeChannels.map(item => item.name);
        this.firstFormGroup.get('youtubeChannels').patchValue(selected);
    }
    onClearAllYoutubeChannels() {
        this.firstFormGroup.get('youtubeChannels').patchValue([]);
    }
    onSelectAllAges() {
    ...
    createCampaign() {
        ...
        this.setBid().then(res => {
            if (res === "ok") {
                ...
                //console.log(this.firstFormGroup.controls.youtubeChannels.value)
                ...
                this.youtubeService.createCampaign(this.uid, this.firstFormGroup.controls.name.value, "PAUSED", this.DateRange.startDate, this.DateRange.endDate, this.numberOfDays, this.valueTotalBudget, this.valueDailyBudget, this.valueTotalBudget, this.firstFormGroup.controls.landingPage.value, this.firstFormGroup.controls.countries.value, this.firstFormGroup.controls.youtubeChannels.value, this.firstFormGroup.controls.ages.value, this.firstFormGroup.controls.genders.value, this.firstFormGroup.controls.devices.value, this.budgetForm.controls.bidChoose.value, this.bid, this.IMAGE_LIST, "Youtube", this.startDateFrench, this.endDateFrench, this.startDateFormattedGoogle, this.endDateFormattedGoogle, this.startDateEnglish, this.endDateEnglish, this.format).then(response => {
                    if (response === "ok") {
...
], CreateYoutubeCampaignComponent.prototype, "DateRange", void 0);
tslib_1.__decorate([
    ViewChild('dateTimePicher', { static: false })
], CreateYoutubeCampaignComponent.prototype, "DateTimePicker", void 0);
tslib_1.__decorate([
    ViewChild('stepper', { static: false })
], CreateYoutubeCampaignComponent.prototype, "stepper", void 0);
tslib_1.__decorate([
    ViewChild('gridSchedule', { static: false })
], CreateYoutubeCampaignComponent.prototype, "gridSchedule", void 0);
tslib_1.__decorate([
    ViewChild('multiselectCountries', { static: false })
], CreateYoutubeCampaignComponent.prototype, "multiselectCountries", void 0);
tslib_1.__decorate([
    ViewChild('multiselectYoutubeChannels', { static: false })
], CreateYoutubeCampaignComponent.prototype, "multiselectYoutubeChannels", void 0);
tslib_1.__decorate([
    ViewChild('multiselectAges', { static: false })
], CreateYoutubeCampaignComponent.prototype, "multiselectAges", void 0);
tslib_1.__decorate([
    ViewChild('multiselectGenders', { static: false })
], CreateYoutubeCampaignComponent.prototype, "multiselectGenders", void 0);
tslib_1.__decorate([
    ViewChild('multiselectDevices', { static: false })
], CreateYoutubeCampaignComponent.prototype, "multiselectDevices", void 0);
tslib_1.__decorate([
    ViewChild('multiselectAdFormat', { static: false })
], CreateYoutubeCampaignComponent.prototype, "multiselectAdFormat", void 0);
tslib_1.__decorate([
    ViewChild('startHourPicker ', { static: false })
], CreateYoutubeCampaignComponent.prototype, "startHourPicker", void 0);
tslib_1.__decorate([
    ViewChild('endHourPicker ', { static: false })
], CreateYoutubeCampaignComponent.prototype, "endHourPicker", void 0);
tslib_1.__decorate([
    ViewChild('bidsChooserComponent ', { static: false })
], CreateYoutubeCampaignComponent.prototype, "bidsChooserComponent", void 0);
tslib_1.__decorate([
    ViewChild(TabComponent, { static: false })
], CreateYoutubeCampaignComponent.prototype, "tab", void 0);
tslib_1.__decorate([
    ViewChild('previewupload', { static: false })
], CreateYoutubeCampaignComponent.prototype, "uploadObj", void 0);
tslib_1.__decorate([
    ViewChild('toast', { static: false })
], CreateYoutubeCampaignComponent.prototype, "ToastAdafriComponent", void 0);
tslib_1.__decorate([
    ViewChild('progressButton', { static: false })
], CreateYoutubeCampaignComponent.prototype, "progressButton", void 0);
CreateYoutubeCampaignComponent = tslib_1.__decorate([
    Component({
        selector: 'app-create-youtube-campaign',
        templateUrl: './create-youtube-campaign.component.html',
        styleUrls: ['./create-youtube-campaign.component.scss']
    })
], CreateYoutubeCampaignComponent);
export { CreateYoutubeCampaignComponent };
//# sourceMappingURL=create-youtube-campaign.component.js.map