...
class NativeAds {
    ...
    addNative(nativeOrArray) {
        this.native = this.native.concat(nativeOrArray);
    }
    getNative() {
        return this.native;
    }
}
let CreateResponsiveDisplayCampaignComponent = class CreateResponsiveDisplayCampaignComponent {
    constructor(_formBuilder, afs, displayService, auth) {
        ...
        this.uid = "";
        this.banner_preview = "assets/images/web-native-dummy-main-image.png";
        this.title = "Titre de l'annonce";
        this.description = "Description de l'annonce";
        this.brand = "Votre marque";
        this.creatives = [];
        // *****************************
        this.path = {
    ...
    ngOnInit() {
        ...
        L10n.load({
            'fr': {
                ...
                grid: {
                    EmptyRecord: 'Aucun element trouvé',
                    Add: 'Ajouter',
                    Edit: "Modifier",
                    Delete: "Supprimer",
                    Update: "Enregistrer",
    ...
    previewCanvas() {
        if (this.secondFormGroup.valid) {
            this.title = this.secondFormGroup.controls.title.value;
            this.brand = this.secondFormGroup.controls.brand.value;
            this.description = this.secondFormGroup.controls.description.value;
            this.editor.rasterizeJSON();
            var obj = JSON.parse(this.editor.json);
            console.log(typeof (this.editor.json));
            console.log(obj);
            if (obj.objects.length > 0) {
                this.editor.rasterize();
                this.banner_preview = this.editor.imageCanvas;
            }
        }
    }
    /*  saveAdafriEditor(): Promise<string>{
    ...
    pushCreatives() {
        return new Promise(resolve => {
            ...
            this.creatives.push({
                ...
                "brand": this.brand,
                "src": this.editor.imageCanvas,
                "dataJson": this.editor.json
            });
            /*  let native = new NativeAds()
           native.addNative(creatives);
           this.creatives = native.getNative() */
            resolve('ok');
        });
    }
    saveAdafriEditor() {
    ...
    saveCanvas() {
        if (this.secondFormGroup.valid) {
            ...
            var obj = JSON.parse(this.editor.json);
            if (obj.objects.length > 0) {
                this.saveAdafriEditor().then(res => {
                    if (res === "ok") {
                        this.pushCreatives().then(push => {
                            if (push === "ok") {
                                let native = new NativeAds();
                                console.log(native.getNative());
    ...
    setBid() {
        return new Promise(resolve => {
            if (this.bidType === "CPM") {
                ...
                this.bid = this.budgetForm.controls.cpc.value;
                resolve("ok");
            }
        });
    }
    createCampaign() {
        ...
        this.setBid().then(res => {
            if (res === "ok") {
                ...
                this.displayService.createCampaign(this.uid, this.firstFormGroup.controls.name.value, "PAUSED", this.DateRange.startDate, this.DateRange.endDate, this.numberOfDays, this.valueTotalBudget, this.valueDailyBudget, this.valueTotalBudget, this.firstFormGroup.controls.landingPage.value, this.firstFormGroup.controls.countries.value, this.firstFormGroup.controls.sites.value, this.firstFormGroup.controls.ages.value, this.firstFormGroup.controls.genders.value, this.firstFormGroup.controls.devices.value, this.budgetForm.controls.bidChoose.value, this.bid, this.creatives, "Native", this.startDateFrench, this.endDateFrench, this.startDateFormattedGoogle, this.endDateFormattedGoogle, this.startDateEnglish, this.endDateEnglish, this.format).then(response => {
                    if (response === "ok") {
...
], CreateResponsiveDisplayCampaignComponent.prototype, "DateRange", void 0);
tslib_1.__decorate([
    ViewChild('dateTimePicher', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "DateTimePicker", void 0);
tslib_1.__decorate([
    ViewChild('stepper', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "stepper", void 0);
tslib_1.__decorate([
    ViewChild('gridSchedule', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "gridSchedule", void 0);
tslib_1.__decorate([
    ViewChild('multiselectCountries', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "multiselectCountries", void 0);
tslib_1.__decorate([
    ViewChild('multiselectSites', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "multiselectSites", void 0);
tslib_1.__decorate([
    ViewChild('multiselectAges', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "multiselectAges", void 0);
tslib_1.__decorate([
    ViewChild('multiselectGenders', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "multiselectGenders", void 0);
tslib_1.__decorate([
    ViewChild('multiselectDevices', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "multiselectDevices", void 0);
tslib_1.__decorate([
    ViewChild('multiselectAdFormat', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "multiselectAdFormat", void 0);
tslib_1.__decorate([
    ViewChild('startHourPicker ', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "startHourPicker", void 0);
tslib_1.__decorate([
    ViewChild('endHourPicker ', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "endHourPicker", void 0);
tslib_1.__decorate([
    ViewChild('bidsChooserComponent ', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "bidsChooserComponent", void 0);
tslib_1.__decorate([
    ViewChild(TabComponent, { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "tab", void 0);
tslib_1.__decorate([
    ViewChild('previewupload', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "uploadObj", void 0);
tslib_1.__decorate([
    ViewChild('toast', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "ToastAdafriComponent", void 0);
tslib_1.__decorate([
    ViewChild('progressButton', { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "progressButton", void 0);
tslib_1.__decorate([
    ViewChild(EditorAdafriComponent, { static: false })
], CreateResponsiveDisplayCampaignComponent.prototype, "editor", void 0);
CreateResponsiveDisplayCampaignComponent = tslib_1.__decorate([
    Component({
        selector: 'app-create-responsive-display-campaign',
        templateUrl: './create-responsive-display-campaign.component.html',
        styleUrls: ['./create-responsive-display-campaign.component.scss']
    })
], CreateResponsiveDisplayCampaignComponent);
export { CreateResponsiveDisplayCampaignComponent };
//# sourceMappingURL=create-responsive-display-campaign.component.js.map